...
SELECT
    ...
    metric,
    unit,
    date_bin(INTERVAL '5 minutes', event_time, TIMESTAMPTZ '2001-01-01 00:00:00+00') AS bucket_start,
...
SELECT
    ...
    metric,
    unit,
    date_bin(INTERVAL '1 hour', event_time, TIMESTAMPTZ '2001-01-01 00:00:00+00') AS bucket_start,
    AVG(value) AS value_avg,
    MIN(value) AS value_min,
    MAX(value) AS value_max,
    COUNT(*)::INTEGER AS sample_count,
